...
function doMethod(str, url, size, foldNum) {
    if (str == '复制') {
        getUsbSpace(1);
...
//        }
//        console.log(url);
        var pathArray = url.split('&'), pathLen = pathArray.length, totalMem = 0;
        if (pathLen > 0) {
            for (var i = 0; i < pathLen; i++) {
                if (pathArray[i].split('=').pop() != '') {
                    console.log(pathArray[i].split('=').pop());
                    MenuMem = 0;
...
//        console.log(bytesToSize(totalMem));
//        return;
        if (totalMem > mem) {
            getMsg('设备空间不足！');
            return;
...
////            console.log(urlList[i].split('=').pop());
//            if (urlList[i].split('=').pop() != '') {
//                fileRm('rm', 's1=' + urlList[i].split('=').pop());
//            }
//        }
