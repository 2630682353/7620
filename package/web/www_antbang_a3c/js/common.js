...
function showPPOE() {
    ...
    if (wanConfigJsonObject.mtu_pppoe == '1480' && wanConfigJsonObject.pppoe_server == '' && wanConfigJsonObject.dns_pppoe == '' && wanConfigJsonObject.dns1_pppoe == '') {
...
function tostroe(){
    document.location = 'http://www.antbang.com/antbang/router';
}
