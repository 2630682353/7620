...
//    })
    ...
    $("#goGet").click(function() {
        var content='<div class="bg"></div> <div class="con"> <p>获取宽带帐号密码</p> <div class="layer-t"> <span class="dot d1 dd"></span> <span class="dot d2 dd"></span> <span class="dot d3 dd"></span> </div> <p class="txt hide">路由器正在获取中...</p> <div class="box"> <a href="javascript:;" class="btn layer-btn cannel" id="cannel">取消</a> <input type="button" class="btn layer-btn inptBtn" onclick="javascript:getPPPOEAccount();" id="getAccount" value="去获取"> </div> </div>';
        layer.open({
            type: 1,
            shadeClose: false,
            content: content,
