...
var autoAccount = $.cookie("account");
var autoPasswd = $.cookie("pwd");
var myAccount = "";
var myPassword = "";
var isGet = false;
var interval = 0;
...
function setPPPOE(account, passwd, server, mac, mtu, dns, dns1, clone) {
    ...
    if (wanInfoJsonObject.connected == 0 || currentMode != 2 || mac != myMac || account != wanConfigJsonObject.user || passwd != wanConfigJsonObject.passwd || dns != wanConfigJsonObject.dns || dns1 != wanConfigJsonObject.dns1 || server != wanConfigJsonObject.pppoe_server || mtu != wanConfigJsonObject.mtu) {
