...
$.vsubmit("submit", function () {
    ...
    if(pm.enable == 0){
		...
		//    /[\x00-\x2C\x2E\x2F\x3A-\x40\x5B-\x5E\x60\x7B-\x7F]{1,32}/.test(pm.dlna_name)  改成了  !/^[a-zA-Z0-9\-_\s]{1,32}$/.test(pm.dlna_name)
        if(!/^[a-zA-Z0-9\-_\s]{1,32}$/.test(pm.dlna_name) || pm.dlna_name == ""){
