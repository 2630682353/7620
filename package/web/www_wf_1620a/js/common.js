...
function netTypeChoic_set(mode){
...
function setmacselect(){
    ...
    if (wanConfigJsonObject.mac == wanConfigJsonObject.hostmac) {
        $("#macEnter1").parent('span').hide();
        $("#macEnter2").parent('span').hide();
        $("#macEnter3").parent('span').hide();
        $("#mac_box1").show();
        $("#mac_box2").show();
        $("#mac_box3").show();        
 ...
 * 设置wifi账户密码
 */
function setWifiAp(ssid, pwd, channel, hidden_ssid, wifiBandwidth, msg) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (jsonObject.error == 0) {
                    ...
                    } else if (jsonObject.value == 2 || jsonObject.value == 0) {
                        mtd_param = 2;
                        $("#showBusinessPic").show();
                        $("#alilink").show();
                        if (mob == 1) {
...
function DynamicList(html, html2, flag, mac, name, ip, speed, up_speed, tmp_down_speed, tmp_up_speed, switch_flag, wifi_flag) {
    ...
    if (flag == 'T') {
        if (mob == 1) {
            ...
            html += '<div class="client-b"><span class="small">' + mac + '</span></div><div class="client-b"><span class="icon"><img src="../../images/m/c-' + wifi_flag + '.png"></span>' + ip + '</div></li>';
    ...
    if (flag == 'F') {
        if (mob == 1) {
            ...
            html2 += '<div class="client-b"><span class="small">' + mac + '</span></div><div class="client-b"><span class="icon"><img src="../../images/m/c-' + wifi_flag + '.png"></span>' + ip + '</div></li>';
