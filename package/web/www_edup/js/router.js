...
$(function () {
//    if (mob == 1) {
//        document.location = "m/index.html?tt=" + new Date().getTime();
//    }
...
//重新检测
    ...
    $(".layui-layer-setwin").live("click", function () {
        //$(window.frames["iframe1"].document).find("input[@name='t1']").css({background:"#369"});      
//        var iframId = $(this).parent('.layui-layer layui-anim layui-layer-iframe ').find('iframe').attr('id');
//        console.log(iframId);
    ...
    $("#ssid_confirm").click(function () {
        ...
        if (pwd.length > 0 && pwd.length < 6) {
            getMsg('Wireless password can not be less than 6 !', 1, '#ssid_pwd');
            return;
        }
        layer.closeAll();
        ssid = encodeURIComponent(ssid);
    ...
    $("#wifi_zj_confirm").click(function () {
        ...
        if (!$("#have_pwd").hasClass("hide")) {
            ...
            if (wf_pwd.length > 0 && wf_pwd.length < 6) {
                getMsg('Wireless password can not be less than 6 !', 1, '#wf_pwd');
                return;
            }
        }
        wf_pwd = encodeURIComponent(wf_pwd);
