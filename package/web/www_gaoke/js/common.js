...
function showPPOE() {
    ...
    if (wanConfigJsonObject.mtu_pppoe == '1480' && wanConfigJsonObject.dns_pppoe == '' && wanConfigJsonObject.dns1_pppoe == '' && wanConfigJsonObject.pppoe_server == '') {
...
function showDHCP() {
    ...
    if (wanConfigJsonObject.mtu_dhcp == '1500' && wanConfigJsonObject.dns_dhcp == '' && wanConfigJsonObject.dns1_dhcp == '') {
        li.each(function () {
            $(this).hide();
...
function showStatic() {
    ...
    if (wanConfigJsonObject.mtu_static == '1500' && wanConfigJsonObject.dns_static == '' && wanConfigJsonObject.dns1_static == '') {
        li.each(function (index) {
            if (index > 2) {
                $(this).hide();
            ...
            success: function (data) {
                ...
                if (jsonObject.error == 0) {
                    if (jsonObject.value == 1) {
                        mtd_param=1;
                        $("#showBusinessPic").hide();
                        $("#alilink").hide();
                        if(mob==0){
                        	$("#businessPic").attr('src', '../images/erweima.png');
                        }else{
                        	$("#businessPic").attr('src', '../../images/erweima.png').hide();
                        }
