...
//重新检测
    ...
    $("#btn_2").click(function () {
        ...
        if (!checkIP(static_ip)||getIPArray(static_ip)[3]>248) {
...
/************/
    ...
    $('#lan_ip').on('input propertychange', function() {
    ...
    $('#lan_ip_start').on('input propertychange', function() {
    ...
    $('#lan_ip_end').on('input propertychange', function() {
