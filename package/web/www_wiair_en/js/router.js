...
//        }
    ...
    $("#lan_btn").click(function () {
        ...
        if (!checkMask(mask)) {
            getMsg("Please input a valid subnet mask !", 1, '#lan_mask');
            return;
        }
...
//    })
    ...
    $("#restart").click(function () {
        layer.confirm('Are you sure you want to restore the initial settings ?', function (i) {
