...
function showPPOE() {
    ...
    var li = $("#t_1_box .pp").find('li');
    
    if (wanConfigJsonObject.dns_pppoe == '' && wanConfigJsonObject.mtu_pppoe == '1480' && wanConfigJsonObject.pppoe_server == '' && wanConfigJsonObject.dns1_pppoe == '') {
...
function showDHCP() {
    ...
    if (wanConfigJsonObject.dns_dhcp == '' && wanConfigJsonObject.mtu_dhcp == '1500' && wanConfigJsonObject.dns1_dhcp == '') {
        li.each(function () {
            $(this).hide();
...
function showStatic() {
    ...
    if (wanConfigJsonObject.dns_static == '' && wanConfigJsonObject.dns1_static == '' && wanConfigJsonObject.mtu_static == '1500') {
        li.each(function (index) {
            if (index > 2) {
                $(this).hide();
            ...
            success: function (data) {
                ...
                if (jsonObject.error == 0) {
                    ...
                    if (jsonObject.value == 1) {
                        ...
                        $("#botlog").attr('src', '../images/bot-logo2.png').removeAttr('style');
                        $("#btypes").attr('src', '../images/bot-logo2.png').removeAttr('style');
                    }
