...
const struct blkid_idinfo vfat_idinfo =
{
	...
	.magics		=
	{
		{ .magic = "FAT32   ", .len = 8, .kboff=0, .sboff = 0x52 },
		{ .magic = "MSDOS",    .len = 5, .kboff=0, .sboff = 0x36 },		
		{ .magic = "MSWIN",    .len = 5, .kboff=0, .sboff = 0x52 },
		{ .magic = "FAT16   ", .len = 8, .kboff=0, .sboff = 0x36 },
		{ .magic = "FAT12   ", .len = 8, .kboff=0, .sboff = 0x36 },
		{ .magic = "FAT     ", .len = 8, .kboff=0, .sboff = 0x36 },
		{ NULL }
	}
};
