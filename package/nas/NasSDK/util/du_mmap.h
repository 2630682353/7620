...
* @brief MMap异常
*/
struct DU_Mmap_Exception : public DU_Exception
{
    DU_Mmap_Exception(const string &buffer) : DU_Exception(buffer){};
    DU_Mmap_Exception(const string &buffer, int err) : DU_Exception(buffer, err){};
    ~DU_Mmap_Exception() throw() {};
};
