...
*  
*/
struct DU_File_Exception : public DU_Exception
{
    DU_File_Exception(const string &buffer) : DU_Exception(buffer){};
    DU_File_Exception(const string &buffer, int err) : DU_Exception(buffer, err){};
    ~DU_File_Exception() throw(){};
};
