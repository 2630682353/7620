#ifndef __DU_SINGLETON_H__
#define __DU_SINGLETON_H__
 ...
 * 
 * class A : public DU_Singleton<A, CreateStatic,  DefaultLifetime>
 * 
 * {
 * 
 *  public:
...
protected:
    ...
    static DU_ThreadLock    _tl;
    static volatile T*      _pInstance;
    static bool             _destroyed;

protected:
    DU_Singleton(){}
    DU_Singleton (const DU_Singleton &); 
    DU_Singleton &operator=(const DU_Singleton &);
};

template <class T, template<class> class CreatePolicy, template<class> class LifetimePolicy> 
DU_ThreadLock DU_Singleton<T, CreatePolicy, LifetimePolicy>::_tl; 

template <class T, template<class> class CreatePolicy, template<class> class LifetimePolicy> 
bool DU_Singleton<T, CreatePolicy, LifetimePolicy>::_destroyed = false; 

template <class T, template<class> class CreatePolicy, template<class> class LifetimePolicy> 
volatile T* DU_Singleton<T, CreatePolicy, LifetimePolicy>::_pInstance = NULL; 
