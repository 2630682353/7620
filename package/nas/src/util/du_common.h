#ifndef __DU_COMMON_H
#define __DU_COMMON_H
...
template<typename T>
T DU_Common::strto(const string &sStr)
{
...
template<typename T>
T DU_Common::strto(const string &sStr, const string &sDefault)
{
    string s;
...
template<typename T>
vector<T> DU_Common::sepstr(const string &sStr, const string &sSep, bool withEmpty)
{
    vector<T> vt;
...
template<typename T>
string DU_Common::tostr(const T &t)
{
...
template<typename T>
string DU_Common::tostr(const vector<T> &t)
{
	string s;
...
template<typename K, typename V, typename D, typename A>
string DU_Common::tostr(const map<K, V, D, A> &t)
{
	string sBuffer;
...
template<typename K, typename V, typename D, typename A>
string DU_Common::tostr(const multimap<K, V, D, A> &t)
{
	string sBuffer;
...
template<typename F, typename S>
string DU_Common::tostr(const pair<F, S> &itPair)
{
	string sBuffer;
	sBuffer += "[";
...
template <typename InputIter>
string DU_Common::tostr(InputIter iFirst, InputIter iLast, const string &sSep)
{
	string sBuffer;
	InputIter it = iFirst;
