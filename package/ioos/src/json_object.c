...
static int json_object_uint64_to_json_string(struct json_object* this,
					  struct printbuf *pb)
{
  return sprintbuf(pb, "%llu", this->o.c_uint64);
}

struct json_object* json_object_new_uint64(unsigned long long i)
{
  struct json_object *this = json_object_new(json_type_int);
  if(!this) return NULL;
  this->_to_json_string = &json_object_uint64_to_json_string;
  this->o.c_uint64 = i;
  return this;
}
