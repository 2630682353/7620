...
function initIframeHeight() {
	var iframeHeight = $("iframe").contents().find("fieldset").height(),
		bodyHeight = $("iframe").contents().find("body").height();
	
	$("iframe").css("height",(iframeHeight + 40)+"px");
	$("iframe").contents().find("body").css("height",(iframeHeight + 40)+"px");
}
...
function controlIframe(width,height) {
	...
	$(".main-dailog").css("left", left + "px");
	$(".main-dailog").css("top", top + "px");
}
