...
define KernelPackage/xhci
  TITLE:=Support for xHCI(USB 3.0) controllers
  KCONFIG:=\
	CONFIG_USB_XHCI_HCD \
...
ifeq ($(strip $(call CompareKernelPatchVer,$(KERNEL_PATCHVER),ge,3.8.0)),1)
  FILES:= \
	...
	$(LINUX_DIR)/drivers/usb/host/xhci-platform.ko
  AUTOLOAD:=$(call AutoLoad,40,xhci-hcd xhci-platform,1)
else
...
define KernelPackage/xhci/description
 Kernel support for XHCI(3.0) controllers
endef

$(eval $(call KernelPackage,xhci))
