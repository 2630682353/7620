...
define KernelPackage/mtk-watchdog
  SUBMENU:=$(OTHER_MENU)
  TITLE:=MTK APSoC WatchDog
  KCONFIG:=CONFIG_RALINK_WATCHDOG
  FILES:=$(LINUX_DIR)/drivers/watchdog/ralink_wdt.ko
  AUTOLOAD:=$(call AutoLoad,80,ralink_wdt)
endef

define KernelPackage/mtk-watchdog/description
 MTK APSoc WatchDog
endef

$(eval $(call KernelPackage,mtk-watchdog))
